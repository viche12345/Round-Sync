...
class DeleteWorkerNotification(var context: Context) : WorkerNotification(context) {
    ...
    override val channel_ongoing_title = mContext.getString(R.string.delete_service_notification_title)
    override val channel_ongoing_description = mContext.getString(R.string.delete_service_notification_description)
